...
public class SignEnveloped {
  ...
  public static Document loadDocument(String file) {
	 ...
	 * alias primer
	 */
	public static Certificate readCertificate(String keyStorePath, String keyStorePassword, String alias) {
		try {
	 ...
	 * alias primer
	 */
	public static PrivateKey readPrivateKey(String keyStorePath, String keyStorePassword, String alias) {
		try {
			//kreiramo instancu KeyStore
			KeyStore ks = KeyStore.getInstance("JKS", "SUN");
